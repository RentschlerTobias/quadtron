...
mesh0 = Data(
    x=meta_mesh.nodes_T3,
    faces=meta_mesh.faces_T3,
    tri_coordinates=meta_mesh.tri_coordinates
)
mesh1 = Data(
    x=meta_mesh.nodes_T4,
    faces=meta_mesh.faces_T4,
    tri_coordinates=meta_mesh.tri_coordinates
)
...
# Bounds für dieses Mesh setzen (wird für detokenize gebraucht)
...
# Bounds wurden durch tokenize oben gesetzt — für generated mesh verwenden
