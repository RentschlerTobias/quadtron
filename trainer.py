...
class Trainer:
    def __init__(
        ...
        self.tokenizer = Tokenizer2D(quantization_levels=quantization)
        ...
        self.model = Meshtron(vocab_size=self.quantization+3,
                              ...
                              max_seq_length=self.max_length+100,
        ...
        self.notation = f'q_{self.quantization}_d_model_{self.d_model}_n_latents{self.n_latents}_batch_size{self.batch_size}'
    ...
    def save_checkpoint(self):
        ...
        best_path = f'{str(self.checkpoint_dir)}_epoch_{self.current_epoch}.pt'
